...
`,L=e=>{let{formik:t,isNotEnoughBalance:r,waitSubmit:i,submitError:n,amountFocused:m,setWaitSubmit:h}=e;const{price:p,period:b,amount:j,tokenSymbol:S}=t.values,{connected:v,userAddress:y}=(0,a.Os)(),{error:k,loading:T,currentPrice:E}=g(),{error:w,loading:Z,orderAvailable:L,orderData:P}=f(p,b,j,E,S);(0,s.useEffect)((()=>{o.px.getData(p,b,j,S)}),[y]);const[I,F]=(0,s.useState)(null),[R,z]=(0,s.useState)(!1);(0,s.useEffect)((()=>{F(k||w)}),[k,w]),(0,s.useEffect)((()=>{z(T||Z)}),[T,Z]);return(0,u.jsxs)(l.Zb,{gap:"30px",height:i?"235px":"auto",errored:v&&r&&!R,children:[R&&(0,u.jsx)(l.TK,{margin:"auto"}),I&&(0,u.jsxs)(u.Fragment,{children:[k&&(0,u.jsx)(l.v0,{message:k}),w&&(0,u.jsx)(l.v0,{message:w})]}),R||I||!L||!P||i?(0,u.jsx)(u.Fragment,{}):(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(l.Zb.Header,{children:(0,u.jsx)(c.ZT,{size:A.y.BIG,align:"left",dangerouslySetInnerHTML:{__html:P.contract_html}})}),(0,u.jsxs)(l.Zb.Body,{children:[!v&&(0,u.jsx)(c.ZT,{align:"left",size:A.y.SMALL,children:"Connect your wallet to make a final transaction"}),v&&r&&(0,u.jsxs)(c.ZT,{align:"left",size:A.y.SMALL,color:d.D.WARNINGS,children:["You need at least"," ","sell"===t.values.direction?`${t.values.amount} ${t.values.tokenSymbol}`:t.values.amount*t.values.price+" USDC"," ","in your wallet to make a transaction"]}),v&&!r&&(0,u.jsx)(l.II,{type:"checkbox",label:"I have read the agreement above and",terms:{content:"Terms and Conditions",link:"https://tymio.com/"},checked:t.values.agreement,onChange:async e=>{await t.setFieldValue("agreement",e.target.checked)}})]}),!v&&(0,u.jsx)(l.Zb.Footer,{children:(0,u.jsx)(c.wK,{width:"100%"})}),v&&!r&&(0,u.jsx)(l.Zb.Footer,{children:(0,u.jsx)(x,{formik:t,loading:R,setWaitSubmit:h,error:n,amountFocused:m})})]}),!R&&!I&&L&&P&&i?(0,u.jsxs)(D,{children:[(0,u.jsxs)("div",{children:[(0,u.jsx)(c.ZT,{size:A.y.BIG,color:d.D.LEMON,style:{marginRight:"10px",textTransform:"capitalize"},children:t.values.direction}),(0,u.jsx)(c.ZT,{size:A.y.BIG,color:d.D.LEMON,style:{marginRight:"10px"},children:`${t.values.amount} ${t.values.tokenSymbol}`}),(0,u.jsx)(c.ZT,{size:A.y.BIG,color:d.D.LEMON,style:{marginRight:"10px"},children:"\u2192"}),(0,u.jsx)(c.ZT,{size:A.y.BIG,color:d.D.LEMON,children:t.values.price*t.values.amount+" USDC"})]}),(0,u.jsx)(c.ZT,{size:A.y.BIG,color:d.D.LEMON,children:"Please confirm transaction with your wallet"})]}):(0,u.jsx)(u.Fragment,{})]})},P=Z.ZP.div`
	display: flex;
	flex-basis: 0;
	flex-grow: 1;
	flex-shrink: 1;
...
`,V=Z.ZP.div`
	...
	cursor: pointer;
	user-select: none;
`,U=e=>{let{setSuccess:t}=e;const r=(0,i.s0)();return(0,u.jsxs)($,{children:[(0,u.jsx)(K,{src:G.Z,alt:"",onClick:()=>{t(!1)}}),(0,u.jsx)(c.H2,{color:d.D.LEMON,children:"Request accepted."}),(0,u.jsxs)(V,{onClick:()=>{r("/profile"),t(!1)},children:[(0,u.jsx)(c.H2,{color:d.D.LIGHT,children:"You could track your"}),(0,u.jsx)(c.H2,{color:d.D.LIGHT,children:"transactions at Profile \u2192"})]})]})},W=e=>{let{config:t}=e;const{ref:r}=(0,i.UO)(),{chainId:c,connected:d,userAddress:x,balance:m,balanceUSDC:h,isNotEnoughBalance:p}=(0,a.Os)(),{direction:g}=(0,a.gm)(),[f]=(0,n.lr)(),b=(0,i.s0)(),[j,S]=(0,s.useState)(null),[v,k]=(0,s.useState)(!1),[T,E]=(0,s.useState)(!1),[w,A]=(0,s.useState)(null),[Z,D]=(0,s.useState)(!1),[P,I]=(0,s.useState)(!1),{formik:F,tokenSymbol:R,price:z,period:N,amount:H,walletError:B,userOrderLoading:G,orderAvailableError:$,configError:K}=y({setSubmitError:A,loading:v,setLoading:k,setWaitSubmit:E,config:t,setSuccess:I});(0,s.useEffect)((()=>{const e=f.get("utm");e&&(window.localStorage.setItem("utm",e),b("/"),o.zu.sendUtm(e,r))}),[f]),(0,s.useEffect)((()=>{if(r){const e=f.get("utm");window.localStorage.setItem("ref",r),b("/"),o.zu.sendUtm(e,r)}}),[r]),(0,s.useEffect)((()=>{S(B||$,K)}),[B,$,K]),(0,s.useEffect)((()=>{k(G)}),[G]),(0,s.useEffect)((()=>{if(z&&N&&H&&R){k(!0),o.g9.getCurrentPrice(R),o.px.getData(z,N,H,R);const e=setTimeout((()=>{F.setValues(F.initialValues)}),3e5);return()=>{clearTimeout(e)}}}),[z,N,H,R]),(0,s.useEffect)((()=>{z&&N&&H&&R&&g&&o.WalletService.isNotEnoughBalance(z,H,g)}),[z,N,H,R,g,m,h]),(0,s.useEffect)((()=>{R&&o.g9.getData(R,g)}),[R,g]),(0,s.useEffect)((()=>{z&&parseFloat(H)>0&&R&&o.ks.getPricePeriods(F.values.price,F.values.amount,F.values.tokenSymbol,!0)}),[R,z,H,x]);const V=!!(z&&N&&H&&Number(H)),W=!!(t&&t.CHAIN_LIST&&c&&t.CHAIN_LIST.includes(Number(c)))||!d;return(0,u.jsxs)(l.W2,{grid:!0,children:[W?"":(0,u.jsxs)(_,{children:[(0,u.jsx)(l.Pz,{}),(0,u.jsx)("span",{children:"Unsupported Network"})]}),j&&(0,u.jsxs)(u.Fragment,{children:[B&&(0,u.jsx)(l.v0,{message:B}),$&&(0,u.jsx)(l.v0,{message:$})]}),!j&&(0,u.jsxs)(l.rj,{margin:"0 15px",columns:2,xsColumns:1,gap:"20px",alignItems:"flex-start",children:[(0,u.jsx)(l.iJ,{column:"span 2",row:1,children:(0,u.jsx)(C,{formik:F,loading:v,setAmountFocused:D})}),(0,u.jsx)(l.iJ,{display:P?"block":"none",column:"span 2",row:2,children:(0,u.jsx)(U,{setSuccess:I})}),(0,u.jsx)(l.iJ,{display:P?"none":"block",column:1,row:2,height:"100%",xsColumn:"span 2",children:(0,u.jsx)(M,{formik:F,loading:v,amountFocused:Z})}),(0,u.jsx)(l.iJ,{display:P?"none":"block",column:2,row:2,height:"100%",xsRow:3,xsColumn:"span 2",children:(0,u.jsx)(O,{formik:F,loading:v,price:z,amount:H,amountFocused:Z})}),V&&(0,u.jsx)(l.iJ,{display:P?"none":"block",row:3,xsRow:4,column:"span 2",xsColumn:"span 2",children:(0,u.jsx)(L,{formik:F,isNotEnoughBalance:p,waitSubmit:T,setWaitSubmit:E,submitError:w,amountFocused:Z})})]})]})}}}]);